...
def vary_traffic_load(num_points=10):
    """Vary traffic load rho = lambda/(2mu)"""
...
def main():
    ...
    print("1. Traffic load (rho) has the MOST significant impact on all metrics")
    print("2. Min-queue strategy consistently outperforms random selection")
    print("3. Blocking probability increases dramatically when rho > 0.8")
